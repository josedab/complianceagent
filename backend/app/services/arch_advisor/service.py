    ...
    "GDPR": [
        {
            ...
            "type": "consent",
            "desc": "Manages user consent for data processing",
            "reqs": ["Art. 6 — Lawful basis", "Art. 7 — Consent conditions"],
        },
        {
            "id": "data-subject-api",
            "name": "Data Subject Rights API",
            "type": "service",
            "desc": "Handles DSAR (erasure, portability, access)",
            "reqs": ["Art. 15-22 — Data subject rights"],
        },
        {
            "id": "encryption-layer",
            "name": "Data Encryption Layer",
            "type": "encryption",
            "desc": "AES-256 encryption at rest and TLS in transit",
            "reqs": ["Art. 32 — Security of processing"],
        },
        {
            "id": "audit-trail",
            "name": "Processing Audit Log",
            "type": "audit",
            "desc": "Immutable record of all data processing activities",
            "reqs": ["Art. 30 — Records of processing"],
        },
    ],
    "HIPAA": [
        {
            ...
            "name": "PHI Vault",
            "type": "encryption",
            "desc": "Encrypted storage for Protected Health Information",
            "reqs": ["§164.312 — Technical safeguards"],
        },
        {
            "id": "access-control",
            "name": "RBAC Access Control",
            "type": "gateway",
            "desc": "Role-based access with MFA for PHI",
            "reqs": ["§164.312(a) — Access control"],
        },
        {
            "id": "audit-log",
            "name": "HIPAA Audit Trail",
            "type": "audit",
            "desc": "Logs all PHI access and modifications",
            "reqs": ["§164.312(b) — Audit controls"],
        },
    ],
    "PCI-DSS": [
        {
            ...
            "type": "service",
            "desc": "Tokenizes card data before storage",
            "reqs": ["Req 3 — Protect stored account data"],
        },
        {
            "id": "network-seg",
            "name": "Network Segmentation",
            "type": "gateway",
            "desc": "Isolates cardholder data environment",
            "reqs": ["Req 1 — Network security controls"],
        },
        {
            "id": "key-mgmt",
            "name": "Key Management System",
            "type": "encryption",
            "desc": "Manages encryption keys with rotation",
            "reqs": ["Req 3.6 — Key management"],
        },
    ],
    "SOC2": [
        {
            ...
            "type": "service",
            "desc": "Continuous monitoring of system availability and security",
            "reqs": ["CC7.1 — System monitoring"],
        },
        {
            "id": "change-mgmt",
            "name": "Change Management",
            "type": "service",
            "desc": "Controlled change approval and deployment process",
            "reqs": ["CC8.1 — Change management"],
        },
        {
            "id": "incident-resp",
            "name": "Incident Response",
            "type": "service",
            "desc": "Automated incident detection and response",
            "reqs": ["CC7.3 — Incident response"],
        },
    ],
}
    ...
    async def generate_architecture(
        ...
        components.append(
            ArchComponent(
                ...
                description="Entry point with rate limiting and auth",
            )
        )
        components.append(
            ArchComponent(
        ...
        connections.append(
            ArchConnection(
                source="api-gateway", target="app-service", label="HTTPS", encrypted=True
            )
        )
        connections.append(
            ArchConnection(
        ...
        for fw in frameworks:
            ...
            recommendations.append(
                f"Ensure all {fw} requirements are addressed in deployment configuration"
            )
