...
class KubernetesAnalyzer:
    ...
    def __init__(self, policy_rules: list[PolicyRule] | None = None):
        ...
        self.policy_rules = policy_rules or [
            r for r in DEFAULT_POLICY_RULES if CloudProvider.KUBERNETES in r.providers
        ]
    ...
    def _check_rule(
                    ...
                    violations.append(
                        self._create_violation(
                            ...
                            remediation=RemediationAction(
                                ...
                                resource_type=parsed.kind,
                                file_path=parsed.file_path,
                                property_path="spec.containers[].securityContext.privileged",
                                current_value=True,
        ...
        if rule.id == "K8S002":
            for container in containers:
                ...
                run_as_non_root = security_context.get("runAsNonRoot") or pod_security.get(
                    "runAsNonRoot"
                )
                    ...
                    violations.append(
                        self._create_violation(
                            ...
                            remediation=RemediationAction(
                                ...
                                resource_type=parsed.kind,
                                file_path=parsed.file_path,
                                property_path="spec.containers[].securityContext.runAsNonRoot",
                                current_value=None,
                    ...
                    violations.append(
                        self._create_violation(
                            ...
                            remediation=RemediationAction(
                                ...
                                resource_type=parsed.kind,
                                file_path=parsed.file_path,
                                property_path="spec.containers[].resources.limits",
                    ...
                    violations.append(
                        self._create_violation(
                            ...
                            remediation=RemediationAction(
                                ...
                                resource_type=parsed.kind,
                                file_path=parsed.file_path,
                                property_path="spec.containers[].image",
                                current_value=image,
                ...
                violations.append(
                    self._create_violation(
                        ...
                        evidence={
                            ...
                            "has_data": bool(data or string_data),
                        },
                        remediation=RemediationAction(
    ...
    def _check_workload_security(
        ...
        for container in containers:
            ...
            pod_spec = (
                parsed.spec.get("template", {}).get("spec", {})
                if "template" in parsed.spec
                else parsed.spec
            )
