...
_SOC2_CONTROLS: list[dict] = [
    ...
    {
        "id": "CC1.2",
        "name": "COSO Principle 2 – Board Oversight",
    ...
    },
    {
        "id": "CC3.2",
        "name": "Risk Analysis",
        "description": "The entity identifies and analyses risks to the achievement of objectives.",
        "category": "Risk Assessment",
    },
    {
        "id": "CC3.3",
    ...
    {
        "id": "CC5.1",
        "name": "Control Activity Selection",
    ...
    },
    {
        ...
        "description": "The entity implements logical and physical access controls over information assets.",
        "category": "Logical and Physical Access Controls",
    },
    {
        "id": "CC6.2",
        "name": "User Registration and Authorization",
        "description": "The entity registers and authorizes new users before granting access.",
        "category": "Logical and Physical Access Controls",
    },
    {
        "id": "CC6.3",
        "name": "Access Removal",
        "description": "The entity removes access to information assets when no longer needed.",
        "category": "Logical and Physical Access Controls",
    },
    {
        "id": "CC6.6",
        "name": "Threat Management",
        "description": "The entity implements controls to prevent or detect and respond to threats.",
        "category": "Logical and Physical Access Controls",
    },
    {
        "id": "CC6.7",
    ...
    },
    {
        ...
        "description": "The entity monitors for anomalies that are indicative of incidents.",
        "category": "System Operations",
    },
    {
        "id": "CC7.3",
        "name": "Incident Response",
        "description": "The entity evaluates events to determine whether they constitute incidents.",
        "category": "System Operations",
    },
    {
        "id": "CC7.4",
        "name": "Incident Recovery",
        "description": "The entity responds to identified incidents by executing defined response procedures.",
        "category": "System Operations",
    },
    {
        "id": "CC8.1",
        "name": "Change Authorization",
        "description": "The entity authorizes, designs, develops, tests, and implements changes.",
...
_ISO27001_CONTROLS: list[dict] = [
    ...
    },
    {
        ...
        "description": "A management framework to initiate and control implementation of information security.",
        "category": "Organization of Information Security",
    },
    {
        "id": "A.6.2",
        "name": "Mobile Devices and Teleworking",
        "description": "Security for mobile devices and teleworking arrangements.",
        "category": "Organization of Information Security",
    },
    {
        "id": "A.7.1",
        "name": "Prior to Employment Screening",
    ...
    },
    {
        ...
        "description": "Employees and contractors are made aware of information security responsibilities.",
        "category": "Human Resource Security",
    },
    {
        "id": "A.7.3",
        "name": "Termination and Change",
    ...
    },
    {
        ...
        "description": "Assets are identified and an inventory of assets is maintained.",
    ...
    },
    {
        "id": "A.8.3",
        "name": "Media Handling",
        "description": "Procedures for management of removable media.",
        "category": "Asset Management",
    },
    {
        "id": "A.9.1",
    ...
    },
    {
        ...
        "description": "Formal user access provisioning and de-provisioning processes.",
        "category": "Access Control",
    },
    {
        "id": "A.9.3",
        "name": "User Responsibilities",
        "description": "Users are accountable for safeguarding their authentication information.",
        "category": "Access Control",
    },
    {
        "id": "A.9.4",
        "name": "System and Application Access Control",
        "description": "Access to systems and applications is controlled via secure log-on procedures.",
        "category": "Access Control",
    },
    {
        "id": "A.10.1",
    ...
    },
    {
        ...
        "description": "Equipment protection from environmental threats and unauthorized access.",
        "category": "Physical and Environmental Security",
    },
    {
        "id": "A.12.1",
        "name": "Operational Procedures",
        "description": "Documented operating procedures available to all users.",
        "category": "Operations Security",
    },
    {
        "id": "A.12.2",
        "name": "Protection from Malware",
        "description": "Detection, prevention, and recovery controls for malware.",
        "category": "Operations Security",
    },
    {
        "id": "A.12.3",
        "name": "Backup",
        "description": "Backup copies of information and software are taken and tested regularly.",
        "category": "Operations Security",
    },
    {
        "id": "A.12.4",
        "name": "Logging and Monitoring",
        "description": "Event logs are produced and regularly reviewed.",
        "category": "Operations Security",
    },
    {
        "id": "A.13.1",
    ...
    },
    {
        ...
        "description": "Policies and procedures protect information transfer.",
        "category": "Communications Security",
    },
    {
        "id": "A.14.1",
        "name": "Security Requirements of Information Systems",
        "description": "Information security requirements included in new systems requirements.",
    ...
    },
    {
        ...
        "description": "Information security requirements for mitigating risks with suppliers.",
        "category": "Supplier Relationships",
    },
    {
        "id": "A.16.1",
        "name": "Incident Management",
        "description": "Consistent approach to management of information security incidents.",
        "category": "Information Security Incident Management",
    },
    {
        "id": "A.17.1",
        "name": "Business Continuity Planning",
        "description": "Information security continuity is embedded in the BCM process.",
        "category": "Business Continuity Management",
    },
    {
        "id": "A.18.1",
        "name": "Compliance with Legal Requirements",
        "description": "Identification of applicable legislation, regulations, and contractual requirements.",
        "category": "Compliance",
    },
    {
        "id": "A.18.2",
        "name": "Information Security Reviews",
        "description": "Independent review of the organization's approach to information security.",
        "category": "Compliance",
    },
]
...
_HIPAA_CONTROLS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Establish policies and procedures for responding to emergencies affecting ePHI.",
        "category": "Administrative Safeguards",
    },
    {
        "id": "164.308(a)(8)",
    ...
    },
    {
        ...
        "description": "Implement policies and procedures for the receipt and removal of hardware and media containing ePHI.",
        "category": "Physical Safeguards",
    },
    {
        "id": "164.312(a)(1)",
    ...
    },
    {
        "id": "164.312(b)",
        "name": "Audit Controls",
        "description": "Implement mechanisms to record and examine access and activity in systems containing ePHI.",
        "category": "Technical Safeguards",
    },
    {
        "id": "164.312(c)(1)",
    ...
    async def collect_evidence_auto(
        ...
        source_templates = [
            (
                ...
                "policy",
                "/docs/policies/security-policy.pdf",
            ),
            (
                EvidenceType.ACCESS_LOG,
                "System Access Audit Log",
                "access_logs",
                "/logs/access-audit-2024.csv",
            ),
            (
                EvidenceType.CONFIGURATION,
                "Encryption Configuration",
                "infrastructure",
                "/config/encryption-settings.json",
            ),
            (
                EvidenceType.TEST_RESULT,
                "Penetration Test Report",
                "security_testing",
                "/reports/pentest-q4.pdf",
            ),
            (
                EvidenceType.TRAINING_RECORD,
                "Security Awareness Training Records",
                "hr_system",
                "/training/completion-report.csv",
            ),
            (
                EvidenceType.INCIDENT_LOG,
                "Incident Response Log",
                "incident_management",
                "/incidents/response-log-2024.json",
            ),
            (
    ...
    def _evaluate_controls(self, framework: AuditFramework) -> list[ControlResult]:
        ...
        for idx, ctrl in enumerate(controls):
            ...
            if status == ControlStatus.NON_COMPLIANT:
                ...
                findings = (
                    f"Control {ctrl['id']} is partially implemented; additional evidence needed."
                )
                remediation = (
                    f"Complete implementation and gather additional evidence for {ctrl['name']}."
                )
