...
PCI_DSS_REQUIREMENTS = {
    ...
    "1.2": {
        "name": "Network security controls configured",
    ...
    "1.4": {
        "name": "Network connections controlled",
        "description": "Network connections between trusted and untrusted networks are controlled.",
        "domain": "1",
    },
    "1.5": {
        "name": "CDE risks mitigated",
        "description": "Risks to the CDE from computing devices connecting to untrusted networks are mitigated.",
        "domain": "1",
    },
    "2.1": {
        "name": "Secure configuration processes",
        "description": "Processes for applying secure configurations are defined and understood.",
        "domain": "2",
    },
    "2.2": {
        "name": "System components secured",
    ...
    "3.1": {
        "name": "Stored account data processes",
        "description": "Processes for protecting stored account data are defined and understood.",
        "domain": "3",
    },
    "3.2": {
        "name": "Data storage minimized",
    ...
    "3.6": {
        "name": "Cryptographic keys secured",
        "description": "Cryptographic keys used to protect stored account data are secured.",
        "domain": "3",
    },
    "3.7": {
        "name": "Key management implemented",
        "description": "Where cryptography is used to protect stored account data, key management processes are defined and implemented.",
        "domain": "3",
    },
    "4.1": {
        "name": "Transmission protection processes",
        "description": "Processes for protecting cardholder data with strong cryptography during transmission are defined.",
        "domain": "4",
    },
    "4.2": {
        "name": "PAN transmission protected",
        "description": "PAN is protected with strong cryptography during transmission.",
        "domain": "4",
    },
    "5.1": {
        "name": "Malware protection processes",
        "description": "Processes for protecting systems from malware are defined and understood.",
        "domain": "5",
    },
    "5.2": {
        "name": "Malware prevented or detected",
        "description": "Malware is prevented or detected and addressed.",
        "domain": "5",
    },
    "5.3": {
        "name": "Anti-malware maintained",
        "description": "Anti-malware mechanisms and processes are active, maintained, and monitored.",
        "domain": "5",
    },
    "5.4": {
        "name": "Anti-phishing implemented",
        "description": "Anti-phishing mechanisms protect users against phishing attacks.",
        "domain": "5",
    },
    "6.1": {
        "name": "Secure development processes",
        "description": "Processes for developing secure systems and software are defined and understood.",
        "domain": "6",
    },
    "6.2": {
        "name": "Custom software secured",
        "description": "Bespoke and custom software is developed securely.",
        "domain": "6",
    },
    "6.3": {
        "name": "Vulnerabilities addressed",
        "description": "Security vulnerabilities are identified and addressed.",
        "domain": "6",
    },
    "6.4": {
        "name": "Web applications protected",
        "description": "Public-facing web applications are protected against attacks.",
        "domain": "6",
    },
    "6.5": {
        "name": "Changes managed securely",
        "description": "Changes to all system components are managed securely.",
        "domain": "6",
    },
    "7.1": {
        "name": "Access restriction processes",
        "description": "Processes for restricting access to system components are defined and understood.",
        "domain": "7",
    },
    "7.2": {
        "name": "Access appropriately assigned",
        "description": "Access to system components and data is appropriately defined and assigned.",
        "domain": "7",
    },
    "7.3": {
        "name": "Access control system used",
        "description": "Access to system components and data is managed via an access control system.",
        "domain": "7",
    },
    "8.1": {
        "name": "User identification processes",
        "description": "Processes for identifying users and authenticating access are defined and understood.",
        "domain": "8",
    },
    "8.2": {
        "name": "User accounts managed",
    ...
    "10.1": {
        "name": "Logging processes defined",
        "description": "Processes for logging and monitoring all access are defined and understood.",
        "domain": "10",
    },
    "10.2": {
    ...
    "10.5": {
        "name": "Audit log history retained",
        "description": "Audit log history is retained and available for analysis.",
        "domain": "10",
    },
    "10.6": {
        "name": "Time synchronization used",
        "description": "Time-synchronization mechanisms support consistent time across systems.",
        "domain": "10",
    },
    "10.7": {
        "name": "Security control failures detected",
        "description": "Failures of critical security control systems are detected, reported, and responded to.",
        "domain": "10",
    },
    "11.1": {
        "name": "Security testing processes",
        "description": "Processes for testing security are defined and understood.",
        "domain": "11",
    },
    "11.2": {
        "name": "Wireless access points monitored",
        "description": "Wireless access points are identified and monitored.",
        "domain": "11",
    },
    "11.3": {
        "name": "Vulnerabilities regularly addressed",
    ...
    "11.6": {
        "name": "Payment page changes detected",
        "description": "Unauthorized changes on payment pages are detected and responded to.",
        "domain": "11",
    },
    "12.1": {
        "name": "Security policy in place",
        "description": "A comprehensive information security policy is known and in place.",
        "domain": "12",
    },
    "12.2": {
        "name": "Acceptable use policies defined",
        "description": "Acceptable use policies for end-user technologies are defined and implemented.",
        "domain": "12",
    },
    "12.3": {
        "name": "Risks formally managed",
        "description": "Risks to the cardholder data environment are formally identified and managed.",
        "domain": "12",
    },
    "12.4": {
        "name": "Compliance managed",
        "description": "PCI DSS compliance is managed throughout the year.",
        "domain": "12",
    },
    "12.5": {
    ...
    "12.6": {
        "name": "Security awareness ongoing",
    ...
    "12.8": {
        ...
        "description": "Risk to information assets from third-party service provider relationships is managed.",
        "domain": "12",
    },
    "12.9": {
        "name": "TPSPs support compliance",
        "description": "Third-party service providers support their customers' PCI DSS compliance.",
        "domain": "12",
    },
    "12.10": {
        "name": "Security incidents responded to",
                ...
                documents.append(
                    {
                        ...
                        "type": "standard"
                        if "standard" in title_elem.get_text().lower()
                        else "guidance",
                    }
                )
