...
_REFERENCE_REPOS: list[ReferenceRepo] = [
    ReferenceRepo(
        id="ref-fintech-py",
        name="fintech-compliance-starter",
    ...
    ReferenceRepo(
        id="ref-healthtech-ts",
        name="hipaa-saas-template",
    ...
    ReferenceRepo(
        id="ref-ecommerce-java",
        name="gdpr-ecommerce-backend",
...
class ComplianceCloningService:
    ...
    async def generate_migration_plan(
        ...
        plan = MigrationPlan(
            ...
            status=CloningStatus.PLANNING,
            total_gaps=len(gaps),
            gaps=gaps,
            estimated_total_hours=total_hours,
            compliance_score_before=45.2,
            compliance_score_after=87.5,
        )
