...
class APIGateway:
    ...
    def get_product(
        self, product_id: UUID | None = None, slug: str | None = None
    ) -> APIProduct | None:
    ...
    def list_api_keys(self, organization_id: UUID) -> list[APIKey]:
        ...
        return [k for k in self._api_keys.values() if k.organization_id == organization_id]
