...
async def list_debt_items(
    ...
    try:
        ...
        raise HTTPException(status_code=422, detail=f"Invalid priority: {priority}") from exc
    ...
    return [
        {
            ...
            "cost_of_delay_per_day": d.cost_of_delay_per_day,
            "accrued_interest": d.accrued_interest,
            "remediation_cost": d.remediation_cost,
            "days_outstanding": d.days_outstanding,
...
async def get_portfolio() -> dict:
    ...
    return {
        "total_debt_value": p.total_debt_value,
        "total_items": p.total_items,
        "critical_items": p.critical_items,
        "high_items": p.high_items,
        "medium_items": p.medium_items,
    ...
    return [
        {
            ...
            "debt_items_count": b.debt_items_count,
