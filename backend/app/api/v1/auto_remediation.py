...
async def trigger_pipeline(
    ...
    return PipelineSchema(
        ...
        violations_detected=pipeline.violations_detected,
        fixes_generated=pipeline.fixes_generated,
...
async def list_pipelines(
    ...
    return [
        PipelineSchema(
            ...
            approval_policy=p.approval_policy.value,
            violations_detected=p.violations_detected,
            fixes_generated=p.fixes_generated,
            pr_url=p.pr_url,
...
async def get_config(db: DB, org: CurrentOrganization) -> RemediationConfigSchema:
    ...
    return RemediationConfigSchema(
        enabled=c.enabled,
        auto_merge_low_risk=c.auto_merge_low_risk,
        scan_on_push=c.scan_on_push,
        scan_on_schedule=c.scan_on_schedule,
        schedule_cron=c.schedule_cron,
        target_frameworks=c.target_frameworks,
...
async def get_stats(db: DB, org: CurrentOrganization) -> RemediationStatsSchema:
    ...
    return RemediationStatsSchema(
        ...
        total_fixes_generated=s.total_fixes_generated,
        total_fixes_merged=s.total_fixes_merged,
