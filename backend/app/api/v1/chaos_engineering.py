...
async def list_experiments(
    ...
    try:
        ...
        raise HTTPException(status_code=422, detail=f"Invalid status: {exp_status}") from exc
    ...
    return [
        {
            ...
            "affected_frameworks": e.affected_frameworks,
    ...
    return [
        {
            ...
            "total_experiments": d.total_experiments,
            "experiments_detected": d.experiments_detected,
...
async def get_stats() -> dict:
    ...
    return {
        ...
        "experiments_detected": s.experiments_detected,
        "experiments_undetected": s.experiments_undetected,
        "avg_mttd_seconds": s.avg_mttd_seconds,
        "avg_mttr_seconds": s.avg_mttr_seconds,
        "detection_rate": s.detection_rate,
        "game_days_completed": s.game_days_completed,
        "controls_validated": s.controls_validated,
        "blind_spots_found": s.blind_spots_found,
    }
