...
@router.post(
    ...
    summary="Handle app installation",
)
...
@router.get(
    "/marketplace", response_model=MarketplaceListingSchema, summary="Get marketplace listing"
)
...
async def update_plan(
    installation_id: int, request: UpdatePlanRequest, db: DB
) -> InstallationSchema:
    service = GitHubAppService(db=db)
...
async def get_check_results(
    db: DB, installation_id: int | None = None, repo: str | None = None
    ...
    return [
        CheckResultSchema(
            ...
            frameworks_checked=r.frameworks_checked,
