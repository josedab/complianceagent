...
async def start_session(
    ...
    return SessionSchema(
        ...
        fixes_proposed=session.fixes_proposed,
...
async def analyze_codebase(
    ...
    analysis = await service.analyze_codebase(
        ...
        file_paths=request.file_paths or None,
    )
    return AnalysisResultSchema(
        ...
        frameworks_checked=analysis.frameworks_checked,
    )
...
async def propose_fix(violation_id: UUID, db: DB, org: CurrentOrganization) -> FixSchema:
    ...
    return FixSchema(
        ...
        article_reference=fix.article_reference,
...
async def explain_regulation(
    ...
    return ExplanationSchema(
        ...
        code_examples=explanation.code_examples,
        related_articles=explanation.related_articles,
    )
