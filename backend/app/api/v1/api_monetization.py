    ...
    return [
        {
            ...
            "requests_per_month": a.requests_per_month,
            "avg_latency_ms": a.avg_latency_ms,
            "pricing_per_request": a.pricing_per_request,
...
@router.post(
    "/subscriptions", response_model=SubscriptionSchema, status_code=status.HTTP_201_CREATED
)
async def create_subscription(req: CreateSubscriptionRequest) -> dict:
    ...
    try:
        ...
        raise HTTPException(status_code=422, detail=f"Invalid tier: {req.tier}") from exc
...
async def get_revenue_stats() -> dict:
    ...
    return {
        ...
        "total_developers": s.total_developers,
        "total_requests_month": s.total_requests_month,
