...
export default function LoginPage() {
  const { login, completeMfa, error: authError, mfaRequired } = useAuth();
  ...
  useEffect(() => {
    ...
    if (token) {
      window.sessionStorage.setItem('pending_invitation_token', token);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <Shield className="h-10 w-10 text-primary-600 mx-auto" />
            <h2 className="mt-4 text-2xl font-bold text-gray-900">Two-Factor Authentication</h2>
          ...
          <form onSubmit={handleMfa} className="space-y-4">
            ...
            <input
              ...
              maxLength={8}
              placeholder="Enter TOTP code or recovery code"
              autoFocus
              className="w-full px-4 py-3 text-center text-2xl tracking-widest border border-gray-300 rounded-lg"
            />
            <button
              type="submit"
